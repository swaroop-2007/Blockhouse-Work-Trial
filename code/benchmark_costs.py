...
class Benchmark:
    ...
    def get_vwap_trades(self, data, initial_inventory, preferred_timeframe=390):
        ...
        if total_volume == 0 or pd.isna(total_volume):
            raise ValueError("Total volume is zero or NaN, which is invalid for VWAP calculation.")
        ...
        for step in range(min(total_steps, preferred_timeframe)):
            ...
            size_of_slice = (volume_at_step / total_volume) * initial_inventory if total_volume else 0
